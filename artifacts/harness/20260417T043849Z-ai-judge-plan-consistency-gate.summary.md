...
- run_id: `20260417T043849Z-ai-judge-plan-consistency-gate`
- status: `fail`
...
- missing_items: `角色一致性,数据一致性,门禁一致性,边界一致性,跨层一致性,收口一致性`
- empty_items: `none`
- placeholder_items: `none`
- arch_missing_items: `none`
- started_at: `2026-04-17T04:38:49Z`
- finished_at: `2026-04-17T04:38:49Z`
