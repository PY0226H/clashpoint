...
use crate::{
    ...
    CreateUser, DebateMessage, DebateNpcAction, DebatePinnedMessage, DebateSessionSummary,
    DebateTopic, DrawVoteDetail, ErrorOutput, ExecuteJudgeReplayOpsInput,
    ExecuteJudgeReplayOpsOutput, GetAuthConsistencyMetricsOutput, GetDrawVoteOutput,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                DebateNpcAction, SubmitDebateNpcActionCandidateInput, SubmitDebateNpcActionCandidateOutput,
