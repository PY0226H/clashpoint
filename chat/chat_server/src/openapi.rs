...
use crate::{
    ...
    BindPhoneV2Output, CreateChat, CreateDebateMessageInput,
    CreateJudgeCalibrationDecisionOpsInput, CreateJudgeCalibrationDecisionOpsOutput, CreateMessage,
    CreateUser, DebateMessage, DebateNpcAction, DebateNpcMessageSnapshot, DebateNpcRoomConfig,
    DebatePinnedMessage, DebateSessionSummary, DebateTopic, DrawVoteDetail, ErrorOutput,
    ExecuteJudgeReplayOpsInput, ExecuteJudgeReplayOpsOutput, GetAuthConsistencyMetricsOutput,
    ...
    GetOpsSloSnapshotOutput, IapOrderProbeStatus, IapOrderSnapshot, IapProduct,
    IapProductsEmptyReason, JoinDebateSessionInput, JoinDebateSessionOutput,
    ...
    ListIapProductsOutput, ListJudgeChallengeOpsQueueOutput, ListJudgeChallengeOpsQueueQuery,
    ...
    SubmitDebateNpcActionCandidateOutput, SubmitDrawVoteInput, SubmitDrawVoteOutput,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                DebateNpcAction, DebateNpcMessageSnapshot, DebateNpcRoomConfig,
                GetDebateNpcDecisionContextOutput, UpsertDebateNpcRoomConfigInput,
