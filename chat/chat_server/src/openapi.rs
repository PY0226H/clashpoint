...
use crate::{
    ...
    BindPhoneV2Output, CreateChat, CreateDebateMessageInput, CreateDebateNpcPublicCallInput,
    CreateJudgeCalibrationDecisionOpsInput, CreateJudgeCalibrationDecisionOpsOutput, CreateMessage,
    CreateUser, DebateAssistantMembershipStatus, DebateAssistantOutput, DebateAssistantQuotaStatus,
    DebateAssistantStatusOutput, DebateMessage, DebateNpcAction, DebateNpcActionFeedback,
    DebateNpcActionPublicItem, DebateNpcMessageSnapshot, DebateNpcPublicCall,
    DebateNpcPublicCallSnapshot, DebateNpcRoomConfig, DebatePinnedMessage, DebateSessionSummary,
    DebateTopic, DrawVoteDetail, ErrorOutput, ExecuteJudgeReplayOpsInput,
    ExecuteJudgeReplayOpsOutput, GetAuthConsistencyMetricsOutput,
    GetDebateNpcDecisionContextOutput, GetDrawVoteOutput, GetIapOrderByTransaction,
    GetIapOrderByTransactionOutput, GetJudgeChallengeOutput, GetJudgeDispatchMetricsOutput,
    GetJudgeFinalDispatchFailureStatsOutput, GetJudgeFinalDispatchFailureStatsQuery,
    GetJudgePublicVerifyOutput, GetJudgeReplayPreviewOpsOutput, GetJudgeReplayPreviewOpsQuery,
    GetJudgeReportFinalOutput, GetJudgeReportOutput, GetJudgeRuntimeReadinessOpsOutput,
    GetJudgeRuntimeReadinessOpsQuery, GetOpsMetricsDictionaryOutput,
    GetOpsObservabilityConfigOutput, GetOpsRbacMeOutput, GetOpsServiceSplitReadinessOutput,
    GetOpsSloSnapshotOutput, GetRateLimitMetricsOutput, IapOrderProbeStatus, IapOrderSnapshot,
    IapProduct, IapProductsEmptyReason, JoinDebateSessionInput, JoinDebateSessionOutput,
    JudgeAssistantAdvisoryOutput, JudgeFinalDispatchFailureTypeCount, JudgeFinalJobSnapshot,
    ...
    JudgeStageSummaryDetail, JudgeStageSummaryInput, JudgeTraceReplayOpsItem, KafkaDlqActionInput,
    KafkaDlqActionOutput, KafkaDlqEventItem, ListAuthSessionsOutput, ListAuthSessionsQueryInput,
    ...
    RateLimitGlobalMetricsOutput, RateLimitScopeMetricsOutput, RedisHealthOutput, RefreshOutput,
    ...
    RevokeOpsRoleOutput, RunOpsObservabilityEvaluationQuery, SendSmsCodeV2Input,
    SendSmsCodeV2Output, SigninOtpV2Input, SigninPasswordV2Input, SigninUser, SignupEmailV2Input,
    SignupPhoneV2Input, SmsDeliveryCallbackV2Input, SmsDeliveryCallbackV2Output,
    SubmitDebateNpcActionCandidateInput, SubmitDebateNpcActionCandidateOutput,
    SubmitDebateNpcActionFeedbackInput, SubmitDrawVoteInput, SubmitDrawVoteOutput,
    ...
    UpdateChat, UpdateChatMembers, UpdateOpsObservabilityAnomalyStateInput,
    UpsertDebateNpcRoomConfigInput, UpsertOpsRoleInput, UpsertOpsServiceSplitReviewInput,
...
#[openapi(
        paths(
            ...
            get_debate_npc_room_config_ops_handler,
            upsert_debate_npc_room_config_ops_handler,
            ...
            crate::handlers::debate_ops::get_judge_runtime_readiness_ops_handler,
            crate::handlers::debate_ops::create_judge_calibration_decision_ops_handler,
            crate::handlers::debate_ops::list_judge_challenge_queue_ops_handler,
            ...
            list_debate_npc_actions_handler,
            create_debate_npc_public_call_handler,
            submit_debate_npc_action_feedback_handler,
            ...
            crate::handlers::debate_judge::get_latest_judge_final_report_handler,
            crate::handlers::debate_judge::get_judge_public_verify_handler,
            crate::handlers::debate_judge::get_judge_challenge_handler,
            crate::handlers::debate_judge::request_judge_challenge_handler,
            crate::handlers::debate_judge::get_debate_assistant_status_handler,
            crate::handlers::debate_judge::request_debate_assistant_query_handler,
            crate::handlers::debate_judge::request_npc_coach_advice_handler,
            crate::handlers::debate_judge::request_room_qa_answer_handler,
            ...
            submit_judge_phase_failed_handler,
            submit_judge_final_report_handler,
            submit_judge_final_failed_handler,
            get_redis_health_handler,
            get_redis_ready_handler,
            get_rate_limit_metrics_handler,
        ...
        components(
            schemas(
                ...
                ListKafkaDlqEventsQuery, KafkaDlqEventItem, ListKafkaDlqEventsOutput, KafkaDlqActionInput, KafkaDlqActionOutput,
                ListJudgeReviewOpsQuery, JudgeReviewOpsItem, ListJudgeReviewOpsOutput,
                GetJudgeRuntimeReadinessOpsQuery, GetJudgeRuntimeReadinessOpsOutput,
                CreateJudgeCalibrationDecisionOpsInput, CreateJudgeCalibrationDecisionOpsOutput,
                ListJudgeChallengeOpsQueueQuery, ListJudgeChallengeOpsQueueOutput,
                ...
                DebateNpcAction, DebateNpcActionPublicItem, DebateNpcMessageSnapshot,
                DebateNpcPublicCallSnapshot, DebateNpcRoomConfig, ListDebateNpcActions,
                ListDebateNpcActionsOutput, CreateDebateNpcPublicCallInput,
                DebateNpcPublicCall, SubmitDebateNpcActionFeedbackInput,
                DebateNpcActionFeedback, GetDebateNpcDecisionContextOutput,
                UpsertDebateNpcRoomConfigInput, SubmitDebateNpcActionCandidateInput,
                SubmitDebateNpcActionCandidateOutput,
                RequestJudgeJobInput, RequestJudgeJobOutput, JudgePhaseJobSnapshot, JudgeFinalJobSnapshot,
                JudgeRagSourceItem, JudgeRagMeta, JudgeStageSummaryDetail,
                JudgeStageSummariesMeta, JudgeReportDetail, JudgeReportProgress, JudgeFinalReportSummary,
                GetJudgeReportOutput, GetJudgeReportFinalOutput, GetJudgePublicVerifyOutput,
                GetJudgeChallengeOutput, RequestJudgeChallengeInput,
                RequestDebateAssistantQueryInput, DebateAssistantMembershipStatus,
                DebateAssistantQuotaStatus, DebateAssistantStatusOutput, DebateAssistantOutput,
                RequestNpcCoachAdviceInput, RequestRoomQaAnswerInput, JudgeAssistantAdvisoryOutput,
                ...
                SubmitJudgeFailedCallbackInput, SubmitJudgeFailedCallbackOutput,
                GetJudgeDispatchMetricsOutput, GetAuthConsistencyMetricsOutput, RedisHealthOutput,
                RateLimitGlobalMetricsOutput, RateLimitScopeMetricsOutput, GetRateLimitMetricsOutput,
