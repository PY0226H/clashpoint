...
use crate::{
    ...
    ListDebateSessionsOutput, ListDebateTopics, ListDebateTopicsOutput, ListIapProducts,
    ListIapProductsOutput, ListJudgeReplayActionsOpsOutput, ListJudgeReplayActionsOpsQuery,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                DebateTopic, DebateSessionSummary, ListDebateTopics, ListDebateTopicsOutput, ListDebateSessions,
                ListDebateSessionsOutput,
