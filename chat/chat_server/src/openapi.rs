...
use crate::{
    ...
    ListAuthSessionsQueryInput, ListDebateMessages, ListDebateMessagesOutput,
    ListDebatePinnedMessages, ListDebateSessions, ListDebateSessionsOutput, ListDebateTopics,
    ListDebateTopicsOutput, ListIapProducts, ListIapProductsOutput,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                DebateMessage, CreateDebateMessageInput, ListDebateMessages, ListDebateMessagesOutput,
