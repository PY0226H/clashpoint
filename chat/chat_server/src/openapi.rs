...
use crate::{
    ...
    ErrorOutput, ExecuteJudgeReplayOpsInput, ExecuteJudgeReplayOpsOutput,
    GetAuthConsistencyMetricsOutput, GetDrawVoteOutput, GetIapOrderByTransaction,
    GetIapOrderByTransactionOutput, GetJudgeDispatchMetricsOutput,
    ...
    IapOrderProbeStatus, IapOrderSnapshot, IapProduct, IapProductsEmptyReason,
    JoinDebateSessionInput, JoinDebateSessionOutput, JudgeFinalDispatchFailureTypeCount,
    JudgeFinalJobSnapshot, JudgeGroundedSummaryPayload, JudgePhaseAgent1ScorePayload,
    ...
    ListAuthSessionsQueryInput, ListDebateMessages, ListDebatePinnedMessages, ListDebateSessions,
    ListDebateTopics, ListIapProducts, ListIapProductsOutput, ListJudgeReplayActionsOpsOutput,
    ListJudgeReplayActionsOpsQuery, ListJudgeReviewOpsOutput, ListJudgeReviewOpsQuery,
    ListJudgeTraceReplayOpsOutput, ListJudgeTraceReplayOpsQuery, ListKafkaDlqEventsOutput,
    ListKafkaDlqEventsQuery, ListMessages, ListOpsAlertNotificationsOutput,
    ListOpsAlertNotificationsQuery, ListOpsRoleAssignmentsOutput,
    ListOpsServiceSplitReviewAuditsOutput, ListOpsServiceSplitReviewAuditsQuery, ListWalletLedger,
    LogoutAllOutput, LogoutOutput, OpsAlertEvalReport, OpsAlertNotificationItem,
    OpsCreateDebateSessionInput, OpsCreateDebateTopicInput, OpsMetricsDictionaryItem,
    OpsObservabilityAnomalyStateValue, OpsObservabilityThresholds, OpsPermissionFlags,
    OpsRoleAssignment, OpsServiceSplitReviewAuditItem, OpsServiceSplitThresholdItem,
    OpsSloRuleSnapshotItem, OpsSloSignalSnapshot, OpsUpdateDebateSessionInput,
    OpsUpdateDebateTopicInput, PinDebateMessageInput, PinDebateMessageOutput, RedisHealthOutput,
    RefreshOutput, RequestJudgeJobInput, RequestJudgeJobOutput, RevokeOpsRoleOutput,
    RunOpsObservabilityEvaluationQuery, SendSmsCodeV2Input, SendSmsCodeV2Output, SigninOtpV2Input,
    SigninPasswordV2Input, SigninUser, SignupEmailV2Input, SignupPhoneV2Input,
    SmsDeliveryCallbackV2Input, SmsDeliveryCallbackV2Output, SubmitDrawVoteInput,
    ...
    WalletLedgerItem, WalletLedgerListOutput, WechatBindPhoneV2Input, WechatChallengeV2Output,
...
#[openapi(
        paths(
            ...
            sms_delivery_callback_v2_handler,
        ...
        components(
            schemas(
                ...
                RequestJudgeJobInput, RequestJudgeJobOutput, JudgePhaseJobSnapshot, JudgeFinalJobSnapshot, GetJudgeReportQuery,
                ...
                GetJudgeDispatchMetricsOutput, GetAuthConsistencyMetricsOutput, RedisHealthOutput,
                ...
                LogoutAllOutput, AuthSessionItem, ListAuthSessionsOutput, ListAuthSessionsQueryInput, AccessTicketsOutput, ErrorOutput
            ),
        ),
