...
use crate::{
    ...
    IapOrderSnapshot, IapProduct, IapProductsEmptyReason, JoinDebateSessionInput,
    JoinDebateSessionOutput, JudgeFinalDispatchFailureTypeCount, JudgeFinalJobSnapshot,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                GetIapOrderByTransaction, IapOrderSnapshot,
