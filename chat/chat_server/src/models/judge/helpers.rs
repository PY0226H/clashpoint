...
pub(super) fn map_final_report_detail(v: JudgeFinalReportRow) -> JudgeFinalReportDetail {
    JudgeFinalReportDetail {
        ...
        debate_summary: v.debate_summary,
        side_analysis: v.side_analysis,
        ...
        verdict_ledger: v.verdict_ledger,
        opinion_pack: v.opinion_pack,
        fairness_summary: v.fairness_summary,
        trust_attestation: v.trust_attestation,
