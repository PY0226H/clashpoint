...
pub(crate) use super::debate_judge::{
    get_debate_assistant_status_handler, get_draw_vote_status_handler, get_judge_challenge_handler,
    get_judge_public_verify_handler, get_latest_judge_final_report_handler,
    get_latest_judge_report_handler, request_debate_assistant_query_handler,
    request_judge_challenge_handler, request_judge_job_handler, request_npc_coach_advice_handler,
    request_room_qa_answer_handler, submit_draw_vote_handler,
};
        ...
        if with_final_report {
            ...
            sqlx::query(
                ...
                VALUES (
                    ...
                    'ops rejudge ready', '{"pro":"pro","con":"con"}'::jsonb, 'verdict reason', '[]'::jsonb, '[]'::jsonb, '[]'::jsonb,
                    'pro', 'con', false, false,
                    '{}'::jsonb, '[]'::jsonb, '[]'::jsonb, 0
                )
                ON CONFLICT (session_id, rejudge_run_no)
