...
ERROR_PHASE_ARTIFACT_INCOMPLETE = "phase_artifact_incomplete"
ERROR_PHASE_IDEMPOTENCY_CONFLICT = "phase_idempotency_conflict"
ERROR_FINAL_ROLLUP_INCOMPLETE = "final_rollup_incomplete"
