...
export type AnalyticsEvent = Message<"analytics.AnalyticsEvent"> & {
  ...
  eventType: {
    ...
    /**
     * @generated from field: analytics.JudgeRealtimeRefreshEvent judge_realtime_refresh = 18;
     */
    value: JudgeRealtimeRefreshEvent;
...
export type UserLoginEvent = Message<"analytics.UserLoginEvent"> & {
   ...
   *
   * @generated from field: string account_identifier_hash = 3;
   */
...
export type UserRegisterEvent = Message<"analytics.UserRegisterEvent"> & {
   ...
   * / 账号标识的哈希值（避免直接落明文 PII）
   *
   * @generated from field: string account_identifier_hash = 4;
   */
  accountIdentifierHash: string;
 ...
 * / AI Judge 判决页实时刷新事件
 *
 * @generated from message analytics.JudgeRealtimeRefreshEvent
 */
export type JudgeRealtimeRefreshEvent = Message<"analytics.JudgeRealtimeRefreshEvent"> & {
  /**
   * / 辩论 session id
   *
   * @generated from field: string debate_session_id = 1;
   */
   ...
   *
   * @generated from field: string source_event_type = 2;
   */
   ...
   * / 本轮累计合并事件数
   *
   * @generated from field: int32 coalesced_events = 6;
   */
 ...
 */
export const JudgeRealtimeRefreshEventSchema: GenMessage<JudgeRealtimeRefreshEvent> = /*@__PURE__*/
