...
1. 生成日期：2026-04-14
2. 运行窗口：2026-04-14T19:45:26Z -> 2026-04-14T19:45:28Z
...
| 子模块 | 状态 | 阈值决策 | 退出码 |
| --- | --- | --- | --- |
| fairness benchmark freeze | `local_reference_frozen` | `accepted` | `0` |
...
3. pack json: `/Users/panyihang/Documents/EchoIsle/artifacts/harness/20260414T194525Z-ai-judge-real-env-window-closure/runtime_ops_pack.summary.json`
4. pack md: `/Users/panyihang/Documents/EchoIsle/artifacts/harness/20260414T194525Z-ai-judge-real-env-window-closure/runtime_ops_pack.summary.md`
