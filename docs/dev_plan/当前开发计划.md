...
| M2：Agent Runtime MVP | 未开始 | 角色编排 + registry 可用 |
...
| `ai-judge-agent-role-runtime-mvp` | 角色化 Agent 主链 | 未开始 | 待执行 |
...
1. `ai-judge-agent-role-runtime-mvp`
2. `ai-judge-registry-runtime`
3. `ai-judge-claim-evidence-ledger-v2`
