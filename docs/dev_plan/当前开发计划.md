...
当前状态：执行中（已完成 `ai-judge-next-iteration-planning`、`ai-judge-p18-registry-prompt-tool-governance-v1`、`ai-judge-p18-evidence-claim-ops-queue-v1`，P18-M3 待执行）
...
1. `ai-judge-p18-courtroom-drilldown-bundle-v1`
