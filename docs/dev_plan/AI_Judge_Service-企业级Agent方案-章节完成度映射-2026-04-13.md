...
| 5. 推荐架构总览 | 法庭式流水线 | 部分落地 | [applications/](/Users/panyihang/Documents/EchoIsle/ai_judge_service/app/applications), [domain/](/Users/panyihang/Documents/EchoIsle/ai_judge_service/app/domain) | 分层与主链迁移已完成；Claim Graph 已接入最小主链，Policy Registry 与高级公平治理未完整实现 |
| 6. 法庭式 Agent 分工 | 8 类 Agent 职责闭环 | 部分落地 | 见“第3节 Agent 子项映射” | Clerk/Arbiter/Opinion + Fairness Gate 主链可用；Claim Graph 已有 bootstrap，Policy Registry 未完成 |
